...
export const AnimatedThemeToggler = ({
  ...
  const isDark = isControlled ? theme === "night" : internalIsDark
  ...
  useEffect(() => {
    return () => {
      ...
      if (root.dataset.magicuiThemeVt !== "inProgress") return
  ...
  useEffect(() => {
    ...
    const updateTheme = () => {
      setInternalIsDark(document.body.classList.contains("night"))
    }
  ...
  const toggleTheme = useCallback(() => {
    ...
    const applyTheme = () => {
      ...
      document.body.classList.toggle("night", newTheme)
      if (isControlled) {
        onThemeChange?.(newTheme ? "night" : "day")
      } else {
        setInternalIsDark(newTheme)
        localStorage.setItem("theme", newTheme ? "night" : "day")
      }
    }
